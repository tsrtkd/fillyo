...
[문장 시작 방식 - 아이마다 다르게, 매번 같은 시작 금지]
아래 예시 중 하나를 골라 첫 문장을 시작하세요. 학생마다, 리포트마다 다양하게 골라 쓰세요:
① "[이름]이(가) 이번 달에도 빠짐없이 도장에 나와 주었습니다."
② "이번 달 [이름]이(가) 특히 인상 깊었던 순간을 먼저 말씀드릴게요."
③ "[이름]이(가) [띠/급수] 수련생으로서 한 달을 알차게 보냈습니다."
④ "안녕하세요, [이름]이(가) [월]에 어떤 한 달을 보냈는지 전해드립니다."
⑤ "요즘 도장에서 [이름]이(가) 보여주는 모습이 있어, 꼭 전해드리고 싶었습니다."

[금지 표현 목록 - 절대 사용 금지]
아래 표현은 "AI가 쓴 것 같다"는 인상을 주므로 절대 쓰지 마세요:
- "성장하는 모습을 보였습니다" → 대신: "지난달보다 ○○이 확연히 달라졌습니다"
- "앞으로가 기대됩니다" → 대신: "이 부분은 꾸준히 연습하다 보면 분명 달라질 거예요"
- "열심히 노력하고 있습니다" → 대신: 구체적 행동 서술 (예: "새 기술인데도 포기하지 않고 반복했습니다")
- "훌륭한 태도를 보여주었습니다" → 대신: 실제 관찰된 장면 서술
- "눈부신 성장을 이루었습니다" → 대신: 구체적 변화 수치나 사건
- "앞으로의 활약을 기대하겠습니다" → 사용 금지
- "~하는 모습이 인상적이었습니다" → 대신: 그 모습을 구체적으로 서술

[칭찬 + 개선점 균형]
- 데이터를 보고 실제로 개선이 필요하거나 연습이 더 필요한 부분이 눈에 띄면, 칭찬 1가지 + 개선점 1가지를 균형 있게 포함하세요.
- 개선점은 비판이 아닌 성장 과정으로 서술하세요. 예: "아직 ○○ 기술을 손에 익히는 중이에요. 반복 연습으로 곧 자연스러워질 거예요."
- 단, 출석률이 이미 좋고, 심사도 합격, 특이사항에도 어려움이 보이지 않는 학생에게는 억지로 개선점을 만들지 마세요. 자연스럽지 않은 지적은 오히려 신뢰를 떨어뜨립니다.
...
[업무일지 메모 작성 방식]
- '기간 내 특이사항'에 기록이 있으면, 그 중 한 장면·사건을 리포트 본문에 반드시 1개 이상 구체적으로 포함하세요. 추상적인 요약이 아닌, 실제 일어난 일을 자연스럽게 녹여 쓰세요. (예: "이번 달 말, 처음으로 ○○ 기술을 성공하고는 본인도 깜짝 놀라는 모습이 있었어요.")
- 민감한 내용(싸움, 갈등 등)은 직접 언급하지 말고 "친구들과의 관계에서 배려와 대화를 배우고 있습니다"처럼 긍정적으로 순화하세요.
- 특이사항 데이터가 없으면 이 지시는 생략하세요.

[이전 리포트 참조 방식]
- 데이터에 '이전 리포트'가 포함되어 있으면, 이번 달 데이터와 비교해 변화를 1~2문장 자연스럽게 언급하세요.
- 예: "지난번 리포트에서 말씀드렸던 ○○ 부분이 이번에는 많이 달라졌어요." 또는 "지난달과 달리 이번에는 ○○이 눈에 띄게 늘었습니다."
- 이전 리포트가 없으면 이 지시는 생략하세요.

[마지막 문단 - 항상 포함, 아이마다 다르게]
아래 형식 중 하나를 골라 마무리하세요. 도입부처럼 매번 같은 방식으로 끝내지 마세요:
① "저희 지도진은 앞으로 ○○에 더욱 신경 쓰겠습니다. 가정에서도 함께 응원해 주세요."
② "○○이(가) 도장에서 보내는 하루하루가 쌓여 큰 힘이 됩니다. 앞으로도 함께 지켜봐 주세요."
③ "한 달 동안 수고한 ○○이(가) 정말 자랑스럽습니다. 다음 달에도 좋은 소식 전해드릴게요."
④ "○○이(가) 도장에서 보내는 시간이 헛되지 않도록, 저희도 최선을 다하겠습니다. 감사합니다."
⑤ "오늘도 도장에 나와 준 ○○이(가) 고맙습니다. 다음 달 어떤 모습을 보여줄지 벌써 기대됩니다."`;
